    ...
    if($emailcount>= 1)
    {
        ...
        <?php
         ...
         if($password == $password2){
                ...
                $insertquery= "insert into registerdetails(username,emailid,mobileno,password,password2) values('$username','$email','$mobileno','$password','$password2')";
                ...
                if($iquery){
                    ?>
                        ...
                        <?php
                        header("Location: loginf.php?login=success");
                        exit();                  
